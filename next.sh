...
╚══════╝╚═╝░░╚═╝╚═╝░░░░░╚══════╝░╚════╝░╚═╝░░░╚═╝
                  CREATED BY 
${ncol}${green}${bold}./EXPLOIT ✗ GALIRUS 404 ✗ Mr 4REX 503 ✗ RidXploit404${ncol}
${cyan}===================================================="
clear
echo -e "${banner}"
echo -e "${yellow}${bold}•KETIK OFF KALO STOP MUSIK KIDS 彡"
echo -e "${green}${bold}•ILIH MENU DIBAWAH INI 彡"
echo -e "╔════════════════════════════════════════╗"
 echo -e "╠═${yellow}${bold}1. TOOLS RIDXPLOIT${ncol}${green}                     ║"
...
mpv --volume=150 https://h.top4top.io/m_3225x59oo1.mp3>clear
        ...
        sleep 2
        echo -e "${banner}"
echo -e "${green} ${bold}PILIH TOOLS DI BAWAH INI彡"
echo -e "╔════════════════════════════════╗"
echo -e "╠═>${yellow}${bold}1. OSINT FOTO BY RidXploit${ncol}${green}${bold}    ║"
echo -e "╠═>${yellow}${bold}2. CP CHEKER BY RidXploit${ncol}${green}${bold}     ║"
echo -e "╠═>${yellow}${bold}3. OSINT PDF BY RidXploit${ncol}${green}${bold}     ║"
echo -e "╠═>${yellow}${bold}4. PHONENUMBER BY RidXploit${ncol}${green}${bold}   ║"
echo -e "╠═>${yellow}${bold}5. WP-CHEKER BY RidXploit${ncol}${green}${bold}     ║"
echo -e "╠═>${yellow}${bold}0. KEMBALI${ncol}${green}${bold}                    ║"
echo -e "╠════════════════════════════════╝"
echo -e "║"
read -p "╚═㉿localhost ══➠ " pilih
    ...
    mpv --volume=150 https://h.top4top.io/m_3225x59oo1.mp3>clear
    clear
    python3 OSINT-FOTO_RidXploit_enc.py
    clear
    bash next.sh
    ...
    then
      mpv --volume=150 https://h.top4top.io/m_3225x59oo1.mp3>clear
    clear
    python3 CPCHEKER_RidXploit_enc.py
    clear
    bash next.sh
    elif [ "$pilih" == "3" ]
    then
    mpv --volume=150 https://h.top4top.io/m_3225x59oo1.mp3>clear
    python3 OSINTPDF_RidXploit_enc.py
    clear
    bash next.sh
    elif [ "$pilih" == "4" ]
    then
      mpv --volume=150 https://h.top4top.io/m_3225x59oo1.mp3>clear
  clear
  python3 PHONUMBER_RidXploit_enc.py
  clear
  bash next.sh
    elif [ "$pilih" == "5" ]
    then
      mpv --volume=150 https://h.top4top.io/m_3225x59oo1.mp3>clear
    clear
    python3 WPCHEKER_RidXploit_enc.py
    clear
    bash next.sh
    elif [ "$pilih" == "0" ]
    then
    ...
    echo -e "${red}${bold}ADUH DEK ADUH DEK"
    bash next.sh
...
echo -e "${banner}"
echo -e "║${green} ${bold}"
echo -e "║PILIH MUSIK BIAR GK BOSEN彡"
echo -e "╠══════════════════════════╗"
...
echo -e "╔════════════════════════════════════════╗"
 ...
 echo -e "╠═${yellow}${bold}7. KEMBALI${ncol}${green}                             ║"
 echo -e "╠════════════════════════════════════════╝"
 echo -e "║"
 read -p "╚═㉿localhost ══➠  " pilih
...
echo -e "${yellow}"
echo -e "LU PASTI SERING PEGANG LILIN YA TIAP MALAM TOD"
...
echo -e "╠════════════════════════════════════════╝"
  ...
  mpv --volume=150 https://g.top4top.io/m_3233kjl821.mp3>clear -&
   echo
   echo -e "${red}${bold}ADUH DEK ADUH DEK"
   sleep 5
   bash next.sh
